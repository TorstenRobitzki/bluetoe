...
BOOST_AUTO_TEST_CASE( Display_Only_Pairing_Algorithm )
{
...
BOOST_AUTO_TEST_CASE( Display_Yes_No_Pairing_Algorithm )
{
    using namespace bluetoe::details;
...
BOOST_AUTO_TEST_CASE( Keyboard_Only_Pairing_Algorithm )
{
    using namespace bluetoe::details;
...
BOOST_AUTO_TEST_CASE( No_Input_No_Output_Pairing_Algorithm )
{
    using namespace bluetoe::details;
...
BOOST_AUTO_TEST_CASE( Keyboard_Display_Pairing_Algorithm )
{
    using namespace bluetoe::details;
