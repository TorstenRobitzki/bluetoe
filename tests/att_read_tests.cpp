...
BOOST_FIXTURE_TEST_CASE( do_i_have_to_wear_a_jacket_today, small_temperature_service_with_response<> )
{
...
BOOST_FIXTURE_TEST_CASE( read_first_part_of_blob, request_with_reponse< blob_server > )
{
    l2cap_input( { 0x0A, 0x03, 0x00 } );
