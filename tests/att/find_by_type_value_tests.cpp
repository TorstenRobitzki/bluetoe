...
BOOST_FIXTURE_TEST_CASE( discover_primary_service_by_service_uuid, request_with_reponse< three_apes_service > )
{
    l2cap_input({
...
BOOST_FIXTURE_TEST_CASE( discover_multiple_primary_service_by_service_uuid, request_with_reponse< server_with_multiple_services > )
{
    l2cap_input({
        0x06, 0x01, 0x00, 0xFF, 0xFF, 0x00, 0x28,
...
BOOST_FIXTURE_TEST_CASE( discover_multiple_primary_service_by_16_bit_service_uuid, request_with_reponse< server_with_multiple_services > )
{
    l2cap_input({
        0x06, 0x01, 0x00, 0xFF, 0xFF, 0x00, 0x28,
...
BOOST_FIXTURE_TEST_CASE( discover_multiple_primary_service_by_16_bit_service_uuid_till_buffer_is_full, request_with_reponse< server_with_20_services > )
{
    l2cap_input({
        0x06, 0x01, 0x00, 0xFF, 0xFF, 0x00, 0x28,
        0x45, 0xFF // Service UUID
