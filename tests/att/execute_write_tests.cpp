...
typedef request_with_reponse< value_server > server_fixture;
...
BOOST_FIXTURE_TEST_CASE( queue_is_release_after_executing, serval_writes )
{
}
...
BOOST_FIXTURE_TEST_CASE( queue_is_release_after_an_error_occured, serval_writes )
{
}
