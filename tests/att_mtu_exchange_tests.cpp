...
BOOST_FIXTURE_TEST_CASE( client_mtu_is_smaller, small_temperature_service_with_response< 0x100 > )
{
...
BOOST_FIXTURE_TEST_CASE( client_mtu_is_larger, small_temperature_service_with_response< 0x100 > )
{
...
typedef request_with_reponse< large_data_service, 30 > request_with_reponse_large_data_service_30;
